                  ...
                  children: [
                    ...
                    PopupMenuButton<String>(
                      ...
                      onSelected: (String result) {
                        ...
                        if (obj.patientListjoining.isNotEmpty &&
                            obj.patientListjoining.length == 2) {
                            ...
                            if (obj.patientList.isEmpty) {
                              ...
                              return
                                ...
                                child: ListTile(
                                  onTap: () {
                                    if (obj.joining) {
                                      if (!obj.patientListjoining.any(
                                          (element) =>
                                              element.id ==
                                              obj.patientList[index].id)) {
                                        obj.patientListjoining
                                            .add(obj.patientList[index]);
                                        obj.update();
                                      } else {
                                        obj.patientListjoining.removeWhere(
                                            (element) =>
                                                element.id ==
                                                obj.patientList[index].id);
                                        obj.update();
